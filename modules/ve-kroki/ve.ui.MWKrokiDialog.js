...
ve.ui.MWKrokiDialog.prototype.initialize = function () {
	...
	// todo -- refactor
	const noneMsg = ve.msg( 'kroki-visualeditor-mwkrokiinspector-none' );
...
ve.ui.MWKrokiDialog.prototype.onLanguageInputChange = function () {
	...
	validity.always( function () {
		const language = dialog.language.getValue();
...
ve.ui.MWKrokiDialog.prototype.getReadyProcess = function ( data ) {
	// Parent process
	const process = ve.ui.MWKrokiDialog.super.prototype.getReadyProcess.call( this, data );
...
ve.ui.MWKrokiDialog.prototype.getSetupProcess = function ( data ) {
	// Parent process
	const process = ve.ui.MWKrokiDialog.super.prototype.getSetupProcess.call( this, data );
	// Mixin process
	return process.next( function () {
...
ve.ui.MWKrokiDialog.prototype.getTeardownProcess = function ( data ) {
	// Parent process
	const process = ve.ui.MWKrokiDialog.super.prototype.getTeardownProcess.call( this, data );
	// Mixin process
	return process;
};
